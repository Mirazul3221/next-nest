...
const EntryPoint = ({user}) => {
    ...
    const handleCallEntry = () => {
        const url = `/userdashboard/components/messanger/video-audio-callcenter?userid=${encodeURIComponent(id)}&name=${encodeURIComponent(name)}&profile=${profile}&title=${title}&type=${type}`
